	...
	<div class="details-w3l py-5">
		<div class="container py-xl-5 py-lg-3">
			<h3 class="title text-capitalize font-weight-light text-dark text-center mb-5">course
				<span class="font-weight-bold">Commerce</span>
			</h3>

			<div class="row inner_sec_info pt-md-4">
			<?php
			    include 'commerceDesc.php';
			?>
				<!-- left side -->
				...
				<div class="col-lg-4 event-right mt-lg-0 mt-sm-5 mt-4">
					<div class="event-right1">
						...
						<div class="tags mt-4 p-4 border">
							<h3 class="blog-title text-dark">More Category</h3>
							<ul class="mt-4">
								<li>
									<a href="#" class="text-dark border">Stories</a>
								</li>
								<li>
									<a href="#" class="text-dark border">Thoughts</a>
								</li>
								<li>
									<a href="#" class="text-dark border">Astrology</a>
								</li>
								<li>
									<a href="#" class="text-dark border">Science Fiction</a>
								</li>
								<li>
									<a href="#" class="text-dark border">Courses</a>
								</li>
								<li>
								...
								<li>
									<a href="#" class="text-dark border">New Course</a>
								</li>
								<li>
									<a href="#" class="text-dark border">Arts</a>
								</li>
		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row">
					<div class="col-md-3 col-6 stats-grid-w3-agile text-center px-xl-5 px-3">
						...
						<p class="text-uppercase text-white border-top pt-4 mt-3">Multiple Users</p>
					</div>
					<div class="col-md-3 col-6 stats-grid-w3-agile text-center  px-xl-5 px-3">
					...
					<div class="col-md-3 col-6 stats-grid-w3-agile text-center mt-md-0 mt-5  px-xl-5 px-3">
						...
						<p class="text-uppercase text-white border-top pt-4 mt-3">certified Professors</p>
					</div>
					<div class="col-md-3 col-6 stats-grid-w3-agile text-center mt-md-0 mt-5  px-xl-5 px-3">
						<div class='numscroller font-weight-bold my-2' data-slno='1' data-min='0' data-max='1200' data-delay='.5' data-increment="1">1200</div>
						<p class="text-uppercase text-white border-top pt-4 mt-3">Certified Candidate</p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row pt-4">
				<div class="col-lg-4 col-news-top text-center">
					...
					<div class="ih-item circle effect16 left_to_right mx-auto">
						<a href="#">
							<div class="img">
								<img src="Assets/images/c1.jpg" alt="img" class="img-fluid rounded-circle">
							</div>
							<div class="info">
								<h3 class="text-capitalize text-white">Courses</h3>
								<p>Description goes here</p>
							</div>
						</a>
					</div>
					<h6 class="small-heading text-capitalize text-center mt-4">
						<a href="#" class="text-dark">Courses
				...
				<div class="col-lg-4 col-news-top text-center my-lg-0 my-sm-5 my-4">
					...
					<div class="ih-item circle effect16 left_to_right mx-auto">
						<a href="#">
							<div class="img">
								<img src="Assets/images/c2.jpg" alt="img" class="img-fluid rounded-circle">
							</div>
							<div class="info">
								<h3 class="text-capitalize text-white">Astrology</h3>
								<p>Description goes here</p>
							</div>
						</a>
					</div>
					<h6 class="small-heading text-capitalize text-center mt-4">
						<a href="#" class="text-dark">Astrology
							<i class="fas fa-long-arrow-alt-right ml-1"></i>
						</a>
					</h6>
					<!-- end normal -->
				...
				<div class="col-lg-4 col-news-top text-center">
					...
					<div class="ih-item circle effect16 left_to_right mx-auto">
						<a href="#">
							<div class="img">
								<img src="Assets/images/c3.jpg" alt="img" class="img-fluid rounded-circle">
							</div>
							<div class="info">
					...
					<h6 class="small-heading text-capitalize text-center mt-4">
						<a href="#" class="text-dark">business
							<i class="fas fa-long-arrow-alt-right ml-1"></i>
						</a>
					</h6>
					<!-- end normal -->
			...
			<div class="row mt-5">
				<div class="col-lg-4 col-news-top text-center">
					...
					<div class="ih-item circle effect16 left_to_right mx-auto">
						<a href="#">
							<div class="img">
								<img src="Assets/images/c4.jpg" alt="img" class="img-fluid rounded-circle">
							</div>
							<div class="info">
					...
					<h6 class="small-heading text-capitalize text-center mt-4">
						<a href="Assets/" class="text-dark">software
							<i class="fas fa-long-arrow-alt-right ml-1"></i>
						</a>
					</h6>
					<!-- end normal -->
				...
				<div class="col-lg-4 col-news-top text-center  my-lg-0 my-sm-5 my-4">
					...
					<div class="ih-item circle effect16 left_to_right mx-auto">
						<a href="#">
							<div class="img">
								<img src="Assets/images/c6.jpg" alt="img" class="img-fluid rounded-circle">
							</div>
							<div class="info">
								<h3 class="text-capitalize text-white">Science Fiction</h3>
								<p>Description goes here</p>
							</div>
						</a>
					</div>
					<h6 class="small-heading text-capitalize text-center mt-4">
						<a href="#" class="text-dark">Science Fiction
							<i class="fas fa-long-arrow-alt-right ml-1"></i>
						</a>
					</h6>
					<!-- end normal -->
				...
				<div class="col-lg-4 col-news-top text-center">
					...
					<div class="ih-item circle effect16 left_to_right mx-auto">
						<a href="#">
							<div class="img">
								<img src="Assets/images/c5.jpg" alt="img" class="img-fluid rounded-circle">
							</div>
							<div class="info">
					...
					<h6 class="small-heading text-capitalize text-center mt-4">
						<a href="#" class="text-dark">Photography</a>
							<i class="fas fa-long-arrow-alt-right ml-1"></i>
						</a>
					</h6>
					<!-- end normal -->

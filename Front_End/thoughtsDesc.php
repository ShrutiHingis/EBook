<?php
  $pid=$_GET['id'];
  $thoughtret=mysqli_query($con,"select * from shayari where book_id='$pid'");
  if(mysqli_affected_rows($con)>0){
    while($data=mysqli_fetch_row($thoughtret)){
      ?>
 ...
 <div class="col-lg-8 single-left">
					<div class="single-left1">
						...
						<h5 class="card-title">
							<a href="course_details.html" class="text-dark"> <b> Content of the course</b></a>
						</h5>
						<p><?php echo $data[6]?></p>
					</div>
					<div class="admin p-4 my-5">
						...
						<a href="#" class="mt-3 font-weight-bold text-right blockquote-footer">Charles W. Eliot</a>
					</div> 
					<div class="social-details p-4 my-5 border">
						...
						<div class="text-right">
							<a class="btn bg-dark text-white" href="buy.php" role="button">Buy Now</a>
						</div>
					</div>
				</div> 
		?>

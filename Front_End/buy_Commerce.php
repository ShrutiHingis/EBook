...
<!-- Mirrored from demo.w3layouts.com/demos_new/template_demo/14-08-2018/edulearn-demo_Free/275217196/web/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Jul 2021 14:58:01 GMT -->
...
<body><link rel="stylesheet" href="Assets/css/font-awesome.min.css">
<!-- New toolbar-->
<style>
* {
  ...
  #w3lDemoBar.w3l-demo-bar .no-margin-bottom-mobile{
	...
	<header>
			...
			<div class="container">
				<div class="row">
					<h1 class="text-capitalize text-white col-7">
						<i class="fas fa-book text-dark bg-white p-2 rounded-circle mr-3"></i>welcome to E-Book</h1>
					<!-- social icons -->
		...
		<div class="middle-w3ls-nav py-2">
			<div class="container">
				<div class="row">
					<a class="logo font-italic font-weight-bold col-lg-4 text-xs-left text-center" href="index.php">LearnopediaEdu</a>
					...
					<ul class="navbar-nav justify-content-center">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu">
								<a class="dropdown-item" href="language.php">IT Courses</a>
								<a class="dropdown-item" href="communication.php">Novels</a>
								<a class="dropdown-item" href="business.php">Astrology</a>
								<a class="dropdown-item" href="software.php">Science Fiction</a>
								<a class="dropdown-item" href="social_media.php">Poems and Poetry</a>
								<a class="dropdown-item" href="photography.php">Stories</a>
								<a class="dropdown-item" href="course_details.php">Romantic</a>
                                <a class="dropdown-item" href="course_details.php">Thoughts</a>
                                <a class="dropdown-item" href="course_details.php">Commics</a>
                        ...
                        <li class="nav-item dropdown">
							...
							<div class="dropdown-menu">
								...
								<a class="dropdown-item" href="horticulture.php">Horticulture</a>
								<a class="dropdown-item" href="evntmangt.php">Event Management</a>
								<a class="dropdown-item" href="envsci.php">Environment Science</a>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="form.php">Apply Now</a>
							</div>
						</li>
...
<h1 class="h3 mb-4 text-dark-800"><u><b>Payment Process</b></u></h1>
 ...
 <form class="user" method="post" action="payment-proccess.php" enctype=multipart/form-data>
                            <?php
                              $id=$_GET['id'];
                              $query=mysqli_query($con,"select * from Commerce where book_id='$id'");
                            ...
                            <div class="form-group row">
                                    <div class="col-sm-4 mb-3 mb-sm-0">
                                        <input type="text" class="form-control"
                                            name="bookid" value="<?php echo $id;?>" readonly>
                                    </div>
                                    <div class="col-sm-4" >
                                        <input type="text" class="form-control"
                                            name="bookname" autocomplete="off" value="<?php echo $row[1];?>" required>
                                    </div>
                                </div>
                                
                                <div class="form-group row">
                                    <div class="col-sm-4 mr-12">
                                        <input type="text" class="form-control"
                                            name="buyername" autocomplete="off" placeholder="Buyer Name" required>
                                    </div>

                                    <div class="col-sm-4 mr-12">
                                        <input type="text" class="form-control"
                                            name="bookprice" autocomplete="off" value="<?php echo $row[2];?>" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8 mr-12" >
                                        <input type="text" class="form-control" name="buyeremail"
                                            placeholder="Buyer Email" autocomplete="off" required>
                                    </div>
                                </div>

...
<div class="brands-w3ls py-md-5 py-4">
	...
	<footer>
		<div class="container py-4">
			<div class="row py-xl-5 py-sm-3">
				<div class="col-lg-6 map">
					...
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14580.116590503085!2d85.38486373043673!3d23.994747801510204!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f49c6210d0ad1f%3A0x1e7613d44dde90e9!2sNutan%20Nagar%20Colony%2C%20Hazaribagh%2C%20Jharkhand%20825303!5e0!3m2!1sen!2sin!4v1629423381477!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
					<div class="conta-posi-w3ls p-4 rounded">
						<h5 class="text-white font-weight-bold mb-3">Address</h5>
						<p>Nutan Nagar(oriya)
							<span>3 No. Thana,Hazaribag</span> Jharkhand,India</p>
					</div>
				</div>
				<div class="col-lg-6 contact-agileits-w3layouts mt-lg-0 mt-4">
					...
					<p class="para-agileits-w3layouts text-white">
						<i class="fas fa-map-marker pr-3"></i>Nutan Nagar Jharkhand,India</p>
					<p class="para-agileits-w3layouts text-white my-sm-3 my-2">
						<i class="fas fa-phone pr-3"></i>8096192209</p>
					<p class="para-agileits-w3layouts">
						<i class="far fa-envelope-open pr-2"></i>
						<a href="mailto:mail@example.com" class=" text-white">shrutihingis2@gmail.com</a>
					</p>
				</div>
			</div>
		</div>
		<div class="copyright-agiles py-3">
			<div class="container">
				<div class="row">
					<p class="col-lg-8 copy-right-grids text-white text-lg-left text-center mt-lg-1">© 2021 LearnopediaEdu. Design by
						<a href="#" target="_blank">Shruti Hingis</a>
					</p>
					<!-- social icons -->
...
<!-- Mirrored from demo.w3layouts.com/demos_new/template_demo/14-08-2018/edulearn-demo_Free/275217196/web/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Jul 2021 14:58:49 GMT -->
</html>
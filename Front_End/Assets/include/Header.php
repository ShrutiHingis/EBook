							...
							<div class="col-sm-4 nav-middle">
								...
								<div class="agile-addresmk">
									<p>
										...
										<a href="mailto:mail@example.com">shrutihingis2@gmail.com</a>
									</p>
								</div>
							</div>
					...
					<ul class="navbar-nav justify-content-center">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu">
								<a class="dropdown-item" href="ItCourse.php">IT Courses</a>
								<a class="dropdown-item" href="novels.php">Novels</a>
								<a class="dropdown-item" href="astrology.php">Astrology</a>
								<a class="dropdown-item" href="scifi.php">Science Fiction</a>
								<a class="dropdown-item" href="popo.php">Poems and Poetry</a>
								<a class="dropdown-item" href="stories.php">Stories</a>
								<a class="dropdown-item" href="romantic.php">Romantic</a>
                                <a class="dropdown-item" href="thoughts.php">Thoughts</a>
                                <a class="dropdown-item" href="commics.php">Commics</a>

			...
			<div class="sub-main-w3 pt-md-4">
				<form action="login_register.php" method="post">
					<div class="form-style-agile form-group">
						...
						<input placeholder="Your Name" class="form-control" name="uname" type="text" required="">
					</div>
					<div class="form-style-agile form-group">
						<label>
							Email
					...
					<div class="form-style-agile form-group">
						...
						<input placeholder="Confirm Password" class="form-control" name="cpassword" id="password2" type="password" required="">
					</div>
					<div class="form-style-agile form-group">
						<label>
							Phone No.
						...
						<input placeholder="Phone No." class="form-control" name="phone" id="phone" type="text" required="" autocomplete="off">
					</div>
					<!-- switch -->
					...
					<p >
						<a href="login.php" class="text-white  font-weight-bold">
							Login</a>
					</p>
				</form>
			</div>

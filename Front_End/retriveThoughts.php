<?php
  $thoughtret=mysqli_query($con,"select * from shayari order by book_id desc limit 6");
...
<div class="row cource-list-agile pt-4">
				...
				<div class="buttons-w3ls">
					<a class="btn button-cour-w3ls text-white" href="thoughtsdetail.php?id=<?php echo $data[0]?>" role="button">Learn More</a>
					<a class="btn bg-dark text-white" href="buy_Thought.php?id=<?php echo $data[0]?>" role="button">Buy Now</a>
				</div>
			</div>
